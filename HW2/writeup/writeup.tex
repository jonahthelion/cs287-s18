...
\begin{enumerate}
\item All models have a \ttfamily{predict} function which given a batch of sentence fragments outputs an array containing the probabilities for the next word for all batches.
...
Scores for the above and other alpha of interest are reported below.
