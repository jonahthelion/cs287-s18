...
All models are trained on the \href{http://aclweb.org/anthology/J93-2004}{Penn Treebank}. For models requiring gradient descent, training loss and validation loss are recorded in real time with \href{https://github.com/facebookresearch/visdom}{visdom}. Final accuracy, roc score, and binary cross entropy which are displayed in the tables are calculated on the test set. These metrics are calculated using \texttt{sklearn.metric}.
