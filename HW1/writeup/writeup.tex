...
I fine-tune ResNet18 to classify images of the text of movie reviews. I'd argue that this problem is strictly harder than any of the above problems because now the network has to learn how to read in addition ot learning how to interpret.\\
...
The network memorizes the training data fairly quickly as seen in Figure \ref{fig:restrain}. However, in order to memorize, the network still manages to learn features which allow it to generalize to near naive bayes performance on the validation and test sets. The final results are shown in Table \ref{tab:resres}.

\begin{figure}
  \centering
  \includegraphics[width=6cm]{imgs/0.png}
  \includegraphics[width=6cm]{imgs/1.png}
  \caption{\label{fig:restext} Images are white, mono text on a black blackground. The text has a random indent do make it more difficult for the network to memorize the training text. }
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=6cm]{imgs/restrain}
  \caption{\label{fig:restrain} Images are white, mono text on a black blackground. The text has a random indent do make it more difficult for the network to memorize the training text. }
\end{figure}
