...
if chosen_model['type'] == 'Conv':
    ...
    model.cuda()
    optimizer = torch.optim.Adam(model.parameters(), lr=0.00002) # list(model.w3.parameters()) + list(model.w4.parameters()) + list(model.w5.parameters()) + list(model.w.parameters()
